...
class GeneroDialog : DialogFragment() {
    ...
    private lateinit var listener: OnGeneroDialogListener

    override fun onAttach(context: Context) {
        super.onAttach(context)
        this.contexto = context;
        listener = context as OnGeneroDialogListener
    }
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        builder.setItems(
            ...
            listener.onGeneroSelected(lista[which])
        //Toast.makeText(context, lista[which], Toast.LENGTH_SHORT).show()
        }
    ...
    interface OnGeneroDialogListener{
        fun onGeneroSelected(gender: String)
    }
